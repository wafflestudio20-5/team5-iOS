...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        self.rootVC = TabBarViewController(homeViewModel: homeViewModel, shopViewModel: shopViewModel, latestStyleFeedViewModel: latestStyleFeedViewModel, followingStyleFeedViewModel: followingStyleFeedViewModel, userInfoViewModel: userViewModel, loginViewModel: loginViewModel, userProfileViewModel: userProfileViewModel)
